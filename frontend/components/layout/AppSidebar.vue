...
<template>
  ...
  <aside
    class="fixed inset-y-0 left-0 z-50 flex h-screen w-64 flex-col border-r-3 border-ink bg-surface transition-transform duration-200 lg:sticky lg:translate-x-0"
    :class="open ? 'translate-x-0' : '-translate-x-full'"
    aria-label="Primary"
  >
    <div class="app-chrome-h flex items-center justify-between gap-3 border-b-3 border-ink px-5">
      <div class="min-w-0">
